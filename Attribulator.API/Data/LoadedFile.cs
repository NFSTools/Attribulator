...
namespace Attribulator.API.Data
{
    ...
    /// </summary>
    public class LoadedFile<TKey> where TKey : struct, IKey<TKey>
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<Vault<TKey>> Vaults { get; }
        ...
        public LoadedFile(string name, string group, IEnumerable<Vault<TKey>> vaults)
        {
            this.Name = name;
            this.Group = group;
            this.Vaults = vaults;
