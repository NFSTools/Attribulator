...
namespace YAMLDatabase.CLI
{
    ...
    public class ApplyScriptOptions : BaseOptions
    {
        ...
        [Option("backup", HelpText = "Whether a YML backup should be made before saving the new database. Enabled by default.")]
        [UsedImplicitly]
        public bool MakeBackup { get; set; } = true;

        [Option("pack", HelpText = "Whether new bin files should be generated after applying the script. Enabled by default.")]
        [UsedImplicitly]
